...
ig.baked=true;ig.module('game.entities.gorilla').requires('impact.entity').defines(function(){EntityGorilla=ig.Entity.extend({size:{x:28,y:29},collides:ig.Entity.COLLIDES.FIXED,animSheet:new ig.AnimationSheet('media/gorilla.png',28,29),init:function(x,y,settings){this.parent(x,y,settings);this.addAnim('idle',0.1,[0])},update:function(){this.parent();}});})
